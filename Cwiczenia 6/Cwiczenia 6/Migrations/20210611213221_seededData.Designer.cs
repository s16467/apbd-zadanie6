...
namespace Cwiczenia_6.Migrations
{
    ...
    [Migration("20210611213221_seededData")]
            ...
            modelBuilder.Entity("Cwiczenia_6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2021, 6, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(788),
                            DueDate = new DateTime(2021, 8, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(1992),
                            IdDoctor = 1,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2021, 6, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4528),
                            DueDate = new DateTime(2021, 10, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4558),
                            IdDoctor = 2,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2021, 6, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4566),
                            DueDate = new DateTime(2021, 7, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4571),
                            IdDoctor = 3,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2021, 6, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4576),
                            DueDate = new DateTime(2022, 2, 11, 23, 32, 21, 133, DateTimeKind.Local).AddTicks(4580),
                            IdDoctor = 4,
                            IdPatient = 4
                        });
                });
