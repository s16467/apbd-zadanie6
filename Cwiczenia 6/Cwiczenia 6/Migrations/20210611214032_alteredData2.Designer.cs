...
namespace Cwiczenia_6.Migrations
{
    ...
    [Migration("20210611214032_alteredData2")]
    partial class alteredData2
    {
            ...
            modelBuilder.Entity("Cwiczenia_6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2021, 6, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(1493),
                            DueDate = new DateTime(2021, 8, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(2189),
                            IdDoctor = 1,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2021, 6, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3811),
                            DueDate = new DateTime(2021, 10, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3823),
                            IdDoctor = 2,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2021, 6, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3829),
                            DueDate = new DateTime(2021, 7, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3833),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2021, 6, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3837),
                            DueDate = new DateTime(2022, 2, 11, 23, 40, 31, 648, DateTimeKind.Local).AddTicks(3840),
                            IdDoctor = 4,
                            IdPatient = 4
                        });
                });
